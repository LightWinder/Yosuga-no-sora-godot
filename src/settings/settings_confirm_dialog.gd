class_name SettingsConfirmDialog
...
@onready var _message: Label = $DialogContent/Center/Main/Message
@onready var _confirm_button: SettingsTextButton = $DialogContent/Center/Main/Buttons/Confirm
@onready var _cancel_button: SettingsTextButton = $DialogContent/Center/Main/Buttons/Cancel
@onready var _always_button: SettingsCheckButton = $DialogContent/AlwaysAsk
