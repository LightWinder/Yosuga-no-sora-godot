class_name SettingsChoiceGroup
extends RefCounted


## Mutually exclusive setting choices. Pages own setting keys and values;
## concrete SettingsSelectableButton subclasses remain presentation-only.
signal value_selected(value: Variant)

var _buttons: Array[SettingsSelectableButton] = []
var _values: Array[Variant] = []


func add_choice(button: SettingsSelectableButton, value: Variant) -> void:
