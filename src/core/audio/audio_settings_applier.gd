class_name AudioSettingsApplier
extends RefCounted


## Applies normalized settings to the buses declared by default_bus_layout.tres.
## Keeping this adapter in core/audio prevents low-level audio code from
## depending on a particular screen or feature.
