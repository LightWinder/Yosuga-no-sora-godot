...
required_files=(
	...
	"assets/themes/save_load/action_group.tres"
	"assets/themes/save_load/action_button_empty.tres"
	"assets/themes/save_load/delete.svg"
	"assets/themes/save_load/copy.svg"
	"assets/themes/save_load/move.svg"
	...
	"assets/shaders/ui/save_slot_metadata_blur.gdshader"
	"assets/shaders/ui/save_slot_metadata_blur_material.tres"
...
require_pattern 'name="BlurredThumbnail" type="TextureRect"' "$project_root/src/save_load/save_slot_card.tscn" "Occupied save slots must overlay metadata on a gradient-blurred thumbnail."
require_pattern 'save_slot_metadata_blur_material\.tres' "$project_root/src/save_load/save_slot_card.tscn" "Save slot metadata blur must use its shared shader material."
require_pattern 'name="ActionPanel" type="PanelContainer"' "$project_root/src/save_load/save_load_page.tscn" "Save/Load footer actions must share the reference-style action panel."
require_pattern 'assets/themes/save_load/delete\.svg' "$project_root/src/save_load/save_load_page.tscn" "Save/Load delete action must expose its vector icon."
require_pattern 'assets/themes/save_load/copy\.svg' "$project_root/src/save_load/save_load_page.tscn" "Save/Load copy action must expose its vector icon."
require_pattern 'assets/themes/save_load/move\.svg' "$project_root/src/save_load/save_load_page.tscn" "Save/Load move action must expose its vector icon."
