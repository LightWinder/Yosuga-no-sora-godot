...
func _run() -> void:
	...
	for key in [&"focus_uv", &"speed", &"distortion_speed", &"distortion_phase", &"distortion_strength_px", &"distortion_scale", &"radial_scale", &"radial_repeat", &"angular_repeat", &"center_fade_start", &"center_fade_end", &"horizon_fade", &"left_lift", &"opacity", &"phase", &"uv_scale", &"uv_offset", &"sky_mask", &"mask_overlap_px"]:
